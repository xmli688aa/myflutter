    ...
    return Scaffold(
      ...
      body: Center(
        child: AnimatedBuilder
          (
            animation: _sizeAnim, builder: (ctx, child) {
          return Icon(
            Icons.favorite, color: Colors.red, size: _sizeAnim.value,);
        }
        ),
      ),
...
class HYAnimatedIcon extends AnimatedWidget {
  ...
  const HYAnimatedIcon(this._sizeAnim, {super.key})
      : super(listenable: _sizeAnim);

  @override
  Widget build(BuildContext context) {
    // Animation<double> anim = _sizeAnim;
